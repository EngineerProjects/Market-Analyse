...
framework, ensuring they are available without circular import issues.
"""
...
[model_selection.capability_requirements]
vision = false
tools = true
...
# Ollama-specific Configuration (Global settings)
[ollama]
...
strict_validation = false    # Whether to strictly validate models
...
DEFAULT_CONFIG_YAML = """# Enterprise AI Configuration (YAML)
